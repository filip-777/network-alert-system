...
class AlertNetworkTest {
    ...
    private final AlertNetwork alertNetwork = new AlertNetworkImpl(inMemoryDependencyRepository, inMemoryServiceRepository);

    private final List<String> SERVICE_NAMES = List.of("A", "B", "C", "D","E","G","H");
    ...
    void addService() {
        ...
        //then
        Assertions.assertEquals(inMemoryServiceRepository.getAllServices().size(), SERVICE_NAMES.size());
    }
    ...
    void should_find_alert_propagation_path() {
        ...
        alertNetwork.addDependency("D", "C");
        //when
        List<String> alertPropagationPath = alertNetwork.findAlertPropagationPath("A", "C");
        //then
    ...
    void should_not_find_alert_propagation_path() {
        ...
        //when
        List<String> alertPropagationPath = alertNetwork.findAlertPropagationPath("A", "H");
        //then
